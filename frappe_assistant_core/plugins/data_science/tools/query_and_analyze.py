...
class QueryAndAnalyze(BaseTool):
    ...
    def _get_dynamic_description(self) -> str:
        ...
        base_description = """Execute custom SQL queries on Frappe database and perform advanced data analysis. Perfect for complex business intelligence, custom reporting, and advanced analytics that go beyond standard reports.
...
🔄 **Progress Streaming Enabled**: This tool provides real-time progress updates during execution."""
        ...
        try:
            ...
            frappe.logger("query_and_analyze").warning(f"Failed to load streaming configuration: {str(e)}")
            return base_description + "\n\n💡 **ARTIFACT STREAMING**: Consider using artifacts for complex query results."
